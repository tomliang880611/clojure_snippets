...
(defmethod tree-make-node IPersistentMap [m children] (apply hash-map (apply concat children)))
...
(defn tree-zipper [node] (zip/zipper tree-branch? tree-children tree-make-node node))
